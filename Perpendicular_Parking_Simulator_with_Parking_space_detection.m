...
plot(pgon_car);
title('EV3 Robot Simulator - Perpendicular Parking with Parking Spot Detection');
...
intp_line_x = [0 1499 1500 1724 1725 2625];
intp_line_y = [300 300 750 750 300 300];
